...
class Blob_Operation:
    ...
    def get_container_client(self, container, log_file):
        ...
        try:
            ...
            self.log_writer.log("Got container client from connection string",)
    ...
    def read_csv(self, fname, container, log_file):
        ...
        try:
            csv_obj = self.get_object(fname=fname, container=container,)

            content = self.read_object(object=csv_obj, make_readable=True,)
    ...
    def upload_file(
        ...
        try:
            client = self.get_container_client(container=container,)
